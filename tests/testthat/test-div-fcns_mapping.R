...
test.gs.set <- parse.geoseg.data(simul.input) %>% head(2)
tmp <-
test_that("gs_tooltips", {
  expect_equal(
    make_tooltips(input = simul.input,
                  test.gs.set),
    c("<b>cz:</b> Johnson City<br><b>Gini - Life expectancy:</b> 0.02<br><b>population:</b> 609,299<br><b>(click to zoom)</b>",
      "<b>cz:</b> Morristown<br><b>Gini - Life expectancy:</b> 0.019<br><b>population:</b> 262,159<br><b>(click to zoom)</b>"
    ))
})
